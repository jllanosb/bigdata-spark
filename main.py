...
def main():
    ...
    try:
        ...
        os.makedirs("resultados", exist_ok=True)
        """
        metricas_df.write.mode("overwrite").csv(
            "resultados/metricas_ventas",
            header=True
        )
        
        ventas_completas_df.write.mode("overwrite").parquet(
            "resultados/ventas_completas.parquet"
        )
        
        """
        base_path = "file:///home/hadoop/proyecto-spark-vscode/resultados"
